...
export const Post = ({likedClick, markedClick, isLiked, isMarked, main_text, reg_data, user__name}:IPost) => {
  const [isSettings, setIsSettings] = useState(false);
    return (
        <div className={`Post ${isLiked && "_liked"} ${isMarked &&"_marked"}`}>
          <div className="UserElem">
            ...
            <div className="user__description">
              ...
              <p className="secondary__text">{reg_data}</p>
            </div>
          </div>
          ...
          <div className="PostControls">
            <div className="icon-wrapper like" onClick={likedClick}>
            ...
            <div className="icon-wrapper mark" onClick={markedClick}>
              <svg
